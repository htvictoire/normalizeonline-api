...
class Dataset(BaseModelMixin, models.Model):
    ...
    suggestion_method = models.CharField(max_length=16, null=True, blank=True)
    extended_type_detection = models.BooleanField(null=True, blank=True)
    suggested_config = models.JSONField(null=True, blank=True)
    suggestion_display = models.JSONField(null=True, blank=True)
    suggestion_confidence = models.JSONField(null=True, blank=True)
